...
class Test_Business_Portal_Sanity_GPR_Personalized_Card:
    ...
    # ==========================================================================================================================
    # =============================================== Issued Digital GPR Card ====================================================

    random_mobile = None   
    random_name = None
    
    @pytest.mark.skip
    def test_Successfully_Issued_Digital_GPR_Card(self, driver):
        ...
        self.random_mobile, random_name = orj_issued_card.Issued_Digital_card_to_GPR_for_Yes_Bank(
    ...
    @pytest.mark.skip                
    def test_Do_Min_kyc_For_Digital_GPR_Card(self, driver):
        
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver)
        
        orj_issued_card.Check_Verification_Issued_card_to_GPR_for_Yes_Bank(random_mobile_no , random_name)
        
        time.sleep(2)
        
    @pytest.mark.skip
    def test_Issued_Digital_GPR_Card_Load_Fund_Limit_exceeded_Check(self, driver):
        
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver)
        
        orj_issued_card.test_Issued_GPR_Card_Load_Fund_Check_Toast_Method(random_mobile_no, 10001 )
        time.sleep(2)
            
    @pytest.mark.skip
    def test_Issued_Digital_GPR_Card_with_successfully_Load_Fund(self, driver):
  
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver)
        
        orj_issued_card.Load_Fund_In_Issue_Card( random_mobile_no, 1000 )
        time.sleep(2)
        
        
    @pytest.mark.skip
    def test_Issued_Digital_GPR_Card_Withdraw_Fund_Lower_than_Amt_Check(self, driver):
  
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver)
        
        orj_issued_card.Issued_GPR_Card_Withdraw_Fund_Check_Toast_Method(random_mobile_no, 10001)
        time.sleep(1)
         
        
    @pytest.mark.skip
    def test_Issued_Digital_GPR_Card_with_successfully_Withdraw_Fund(self, driver):   
        
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver) 
        
        orj_issued_card.Withdraw_Fund_In_Issue_Card_For_GPR(random_mobile_no, 100)
        time.sleep(2)
    ...
    @pytest.mark.skip 
    def test_Issued_Digital_GPR_Card_with_Do_Freeze_Card(self, driver):
 
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver)     
        
        orj_issued_card.Do_freeze_card_For_GPR_Card(random_mobile_no) 

    @pytest.mark.skip 
    def test_Issued_Digital_GPR_Card_with_Do_UnFreeze_Card(self, driver):
  
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver) 

        orj_issued_card.Do_Unfreeze_card_For_GPR_Card(random_mobile_no)
        time.sleep(2) 
    
    @pytest.mark.skip     
    def test_Issued_Digital_GPR_Card_Check_Print(self, driver):
        
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver)
        
        orj_issued_card.Print_Digital_Card_In_GPR_YES_Bank(random_mobile_no)
        time.sleep(2)  
         
        
    @pytest.mark.skip    
    def test_Issued_Digital_GPR_Card_Doing_Block_Card(self, driver):
  
        # Create object for Issue Card  
        orj_issued_card = Issued_Card_class(driver) 

        orj_issued_card.Do_Block_Card_For_GPR_Card(random_mobile_no)
        time.sleep(2)


    # # ==========================================================================================================================
    # # =============================================== Issued Personalized GPR Card ====================================================
    ...
    @pytest.mark.skip                
    def test_Do_Min_kyc_For_GPR_Personalized_Card(self, driver):
